  ...
  questions: [
    {
      ...
      answer: ["A", "D", "G"],
      explanation:
        "Option A (equality operator) and option D (logical complement operator) can be used on boolean values. Option G is also correct as you can cast a boolean variable since boolean is a type. The arithmetic operators (+, --, %, ~) cannot be applied to boolean values.",
    },
    {
      question:
      ...
      answer: ["A", "B", "D"],
      explanation:
        "The expression apples + oranges is automatically promoted to int, so int and data types that can be promoted automatically from int will work. Options A, B, and D are such data types. Option C will not work because boolean is not a numeric data type. Options E and F will not work without an explicit cast to a smaller data type.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer: ["D"],
      explanation:
        "The post-increment operator (x++) increases the value but returns the original value. The pre-decrement operator (--x) decreases the value and returns the new value. Therefore, option D is the correct answer.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer: ["B", "E", "G"],
      explanation:
        "Option A is incorrect as the return value of an assignment operation is the same as the value of the newly assigned variable. Option B is correct, as the equality (==) and inequality (!=) operators can both be used with objects. Option C is incorrect, as boolean and numeric types are not comparable. Option D is incorrect, as logical operators evaluate both sides of the expression. The (|) operator will cause both sides to be evaluated. Option E is correct. Option F is incorrect, as Java does not accept numbers for boolean values. Finally, option G is correct, as you need to use the negation operator (-) to flip or negate numeric values, not the logical complement operator (!).",
    },
    {
      question:
    ...
    },
    {
      ...
      answer: ["A"],
      explanation:
        "Only parentheses, ( ), can be used to change the order of operation in an expression, making option A correct. The other operators, such as [ ], < >, and { }, cannot be used as parentheses in Java.",
    },
    {
      question:
        "What is the output of executing the following application?\n\nint start = 7;\nint end = 4;\nend += ++start;\nstart = (byte)(Byte.MAX_VALUE + 1);",
      options: [
        "A. start is 0.",
        "B. start is -128.",
        "C. start is 127.",
      ...
      answer: ["B", "F"],
      explanation:
        "The code compiles and runs successfully, so options G and H are incorrect. On line 3, the pre-increment operator is executed first, so start is incremented to 8, and the new value is returned as the right side of the expression. The value of end is computed by adding 8 to the original value of 4, leaving a new value of 12 for end and making option F a correct answer. On line 4, we are incrementing one past the maximum byte value. Due to overflow, this will result in a negative number, making option B the correct answer. Even if you didn't know the maximum value of byte, you should have known the code compiles and runs and looked for the answer for start with a negative number.",
    },
    {
      question:
